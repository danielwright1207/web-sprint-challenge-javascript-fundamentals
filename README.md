...
forEach and map are similair in that they both iterate through every item in the array however .forEach does not return a new array like .map does.
...
5. Why do we need super() in an extended class?
   super() abstracts away syntax that we used with .bind in object prototypes
