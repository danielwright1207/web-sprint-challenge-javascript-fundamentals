...
function summation(param /*Your Code Here*/) {
  let sum = 0;
...
/* 🦁🦁🦁 Request 1: .forEach() 🦁🦁🦁
  ...
  */
function animalNames(zooAnimals /*Your Code Here*/) {
  const displayNames = [];
  ...
  return displayNames; /*Your Code Here*/
}

/* 🦁🦁🦁 Request 2: .map() 🦁🦁🦁
  The zoos need a list of all their animal's names (animal_name only) converted to lower case. Using map, create a new array of strings named lowCaseAnimalNames, each string following this pattern: "jackal, asiatic". Log the resut.
  */
function lowerCaseNames(zooAnimals /*Your Code Here*/) {
  const animalNames = zooAnimals.map(function (item) {
    return item.animal_name.toLowerCase();
  });
  return animalNames;
  console.log(animalNames); /*Your Code Here*/
}

/* 🦁🦁🦁 Request 3: .filter() 🦁🦁🦁
  The zoos are concerned about animals with a lower population count. Using filter, create a new array of objects called lowPopulationAnimals which contains only the animals with a population less than 5.
  */
function lowPopulationAnimals(zooAnimals /*Your Code Here*/) {
  const lowPopAnimals = zooAnimals.filter(function (item) {
    return item.population < 5;
  });
  return lowPopAnimals; /*Your Code Here*/
}

/* 🦁🦁🦁 Request 4: .reduce() 🦁🦁🦁
  The zoos need to know their total animal population across the United States. Find the total population from all the zoos using the .reduce() method. Remember the reduce method takes two arguments: a callback (which itself takes two args), and an initial value for the count.
  */
function USApop(zooAnimals /*Your Code Here*/) {
  const totalAnimalPop = zooAnimals.reduce(function (accumulator, item) {
    return accumulator + item.population;
  }, 0);
  return totalAnimalPop; /*Your Code Here*/
}
...
*/
function CuboidMaker(surfaceArea /*Your Code Here */) {
  this.length = surfaceArea.length;
